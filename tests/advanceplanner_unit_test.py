...
class PlannerAdvanceTester(unittest.TestCase):
    ...
    def test_decision_for_typical_day_advance(self):
        ...
        self.planner.logfile_completion_checking = config.LOGFILE_CHECKING['LAX'] # seems this happens even without declaring it here - need to reset these in tearDown()
    ...
    def test_decision_for_first_week_too_short_day_advance(self):
        ...
        self.planner.date = now.date()
        self.planner.tomorrow_checking = config.LOGFILE_CHECKING['LAX']
        self.planner.logfile_completion_checking = config.LOGFILE_CHECKING['LAX']
        status = advanceplanner.advance_planner(self.planner, now)
        self.assertEqual(status, PlannerPeriod.Day)
    ...
    def test_planner_advance_week_agenda(self):
        ...
        logfile = advanceplanner.update_logfile_agenda(self.planner.weekfile, dayagenda)
    ...
    def test_planner_advance_month_agenda(self):
        ...
        logfile = advanceplanner.update_logfile_agenda(self.planner.monthfile, weekagenda)
    ...
    def test_planner_advance_quarter_agenda(self):
        ...
        logfile = advanceplanner.update_logfile_agenda(self.planner.quarterfile, monthagenda)
    ...
    def test_planner_advance_year_agenda(self):
        ...
        logfile = advanceplanner.update_logfile_agenda(self.planner.yearfile, quarteragenda)
